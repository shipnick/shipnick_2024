...
<div class="content container-fluid">
    ...
    <div class="row">
            ...
            <div class="widget settings-menu">
                <ul>
                    ...
                    <li class="nav-item my-2">
                        <a href="{{ asset('/financial-details') }}" class="nav-link active btn btn-primary">
        ...
        <div class="col-xl-9 col-md-8">
            ...
            @if(session('status')=="Financial detail add successfully")
                ...
                <div class="modal-body">
                    <form method="post" action="{{ asset('/financial-details') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="acno" required="">
                        </div>
                        <div class="form-group">
