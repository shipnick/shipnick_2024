...
.leftmargin{
	...
	<div style="float:left; width:99%;">
		<table width="100%" border="1" style="border-collapse: collapse;">
			<tr>
<td colspan="5" class="text-center">Fulfilled by SHIPDART
...
// echo '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG($orderno, 'C39+',3,33,array(1,1,1)) . '" alt="barcode" style="max-width:99%" />';
 ...
 <!--<br><br>-->
			...
			<!--<tr>-->
			<!--	<td colspan="2" class="leftmargin">Net Amount</td>-->
			<!--	<td colspan="3" class="leftmargin">{{ ucwords($params->Cod_Amount) }}</td>-->
			<!--</tr>-->
			<tr>
