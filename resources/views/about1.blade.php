        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>About</h2>
              <p>We are aggregator in Logistic soloutions. We have advanced application to provide advanced logistic services.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content order-last  order-lg-first">
            <h3>About Us</h3>
            <p>
              We are aggregator in Logistic soloutions. We have advanced application to provide advanced logistic services. Contact us and delivered with us.
            </p>
            <ul>
              <li data-aos="fade-up" data-aos-delay="100">
                <i class="bi bi-diagram-3"></i>
                <div>
                  <h5>Discounted rates</h5>
                  <p>Use our platform for free, no additional payments are required.</p>
                </div>
              </li>
              <li data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  ...
                  <p>Create and verify your account in under 1 minute.</p>
                </div>
              </li>
              <li data-aos="fade-up" data-aos-delay="300">
                ...
                <div>
                  ...
                  <p>24/7 support through: Online chat, Social Media, Telephone, Email, Help Center and Whatsapp.</p>
                </div>
              </li>
            </ul>
          </div>
