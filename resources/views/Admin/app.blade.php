...
<div class="nav-header">
	<a href="{{ asset('/AdminPanel') }}" class="brand-logo">
		...
		<nav class="navbar navbar-expand">
			<div class="collapse navbar-collapse justify-content-between">
				<div class="header-left">
					...
					Hi,  {{ session('UserLogin1name') }}
					</div>
				</div>
				<ul class="navbar-nav header-right">
					<!--<li class="nav-item">-->
					<!--			<a class="btn btn-primary" href="javascript:void();"><i class="fa fa-shopping-basket me-2"></i>Drop Shipping</a>-->
					<!--</li>-->
...
<!--**********************************
        ...
        ***********************************-->
        <style></style>
<div class="dlabnav fixed-sidebar">
		...
		<ul class="metismenu" id="menu">
			...
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<ul aria-expanded="false">
					...
					<li><a href="{{ asset('/AdminPanel') }}">Dashboard</a></li>
				</ul>
			</li>
			<!--<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">-->
			...
			<!--		<li><a href="{{asset('/All_Orders_Complete')}}">All orders</a></li>-->
			<!--	</ul>-->
			<!--</li>-->
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="flaticon-381-share"></i>
					<span class="nav-text">Rate Manage</span>
				</a>
				<ul aria-expanded="false">

					<li><a href="{{asset('/admin-rate-manage')}}">Rate Manage</a></li>
				</ul>
			</li>
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="flaticon-381-folder-17"></i>
					<span class="nav-text">Courier Manage</span>
				</a>
				<ul aria-expanded="false">
					<li><a href="{{ asset('/courier') }}">Courier Manage</a></li>

				</ul>
			</li>
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="flaticon-381-home-2"></i>
					<span class="nav-text">Merchants Manage</span>
				</a>
				<ul aria-expanded="false">
					<li><a href="{{ asset('/New_Client') }}">Registration</a></li>
			...
			<!--	</a>-->
			<!--	<ul aria-expanded="false">-->
			<!--		<li><a href="{{ asset('/AMIS_Report') }}">MIS Reports<span class="badge badge-xs badge-success ms-3">Update</span></a></li>-->
			<!--		<li><a href="{{ asset('/AReturn_POD_Report') }}">Menifest<span class="badge badge-xs badge-success ms-3">NDR</span></a></li>-->
			<!--		<li><a href="{{ asset('remittance-new') }}">NDR<span class="badge badge-xs badge-success ms-3">Remittance</span></a></li>-->
			<!--	</ul>-->
			<!--</li>-->
			...
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="{{ asset('/order-tracking-no') }}">Order Tracking</a></li>
				</ul>
			</li>
