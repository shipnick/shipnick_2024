                    ...
                    <div class="login-form">
                        ...
                        <form action="{{ asset('/new-client-registration-added') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="bname" class="form-control form-control" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <input type="text" name="mobile" class="form-control form-control" >
                            </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="cityname" class="form-control form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="gstno" class="form-control form-control">
                            </div>
                                </div>
                                <div class="col-md-6">
                                <div class="mb-4">
                                <label class="mb-1 text-dark">PAN</label>
                                <input type="text" class="form-control form-control" name="panno">
                            </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control form-control" name="" id="" cols="10" rows="4" name="address"></textarea>
                                
                            </div>
                            <div class="mb-4 position-relative">
                                <label class="mb-1 text-dark">Create Password</label>
                                <input type="password" name="createpassword" id="txtNewPassword" class="form-control form-control">
                            ...
                            <div class="mb-4 position-relative">
                                ...
                                <input type="password" name="password" id="txtConfirmPassword" class="form-control form-control">
                                <span class="show-pass eye">
