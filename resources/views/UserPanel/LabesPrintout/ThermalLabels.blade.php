...
<div class="col-md-12">
	...
	<div style="float:left; width:435px;">
		...
		<table width="100%" border="1" style="border-collapse: collapse;">
			<tr>
					<td colspan="5" class="text-center">Fulfilled by Artulogistic 
...
echo '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG($awbno, 'C39+',2,33,array(1,2,3)) . '" alt="barcode" style="max-width:99%" />';
 ?>
<br>
AWB - {{ $params[$i]['awb'] }} <br>
<!--<br>-->
...
// echo '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG($params[$i]['orderno'], 'C39+',3,33,array(1,1,1)) . '" alt="barcode" style="max-width:99%" />';
 ...
 <!--<br><br>-->
			...
			<tr>
				...
				<!--<td colspan="3">-->
				<!--    <center>-->
				<!--        <img src="{{ asset('HubDetails') }}/{{ $params[$i]['hfolder'] }}/{{ $params[$i]['hlogo'] }}" title="Hub Image" style="width:50px;height:50px;">-->
				<!--    </center>-->
				<!--</td>-->
			</tr>
			<tr>
