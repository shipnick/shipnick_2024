	...
	<div style="width:99%;"><br> <!-- Main Div -->
		...
		<div style="float:left; width:99%;">
			<table width="100%" border="1" style="border-collapse: collapse;">
				...
				<tr>
					<td colspan="5">
						...
						<div class="col-md-6"><img src="{{ asset('HubDetails') }}/{{ $Hubs['hub_folder'] }}/{{ $Hubs['hub_img'] }}" title="Hub Image" style="width:100px;height:100px;"></div>
						<div class="col-md-6 " style="text-align: right;">Order No : <b>{{ ucwords($params->orderno)
								}}</b></div>
					</td>
				</tr>
			...
			Pincode : <b>{{ ucwords($params->cpin) }}</b><br> -->
						<b>Address :</b> {{ ucwords($params->Address) }}, {{ ucwords($params->City) }}, {{
						ucwords($params->Pincode) }}. <br><br>
						Mobile : <b>{{ ucwords($params->Mobile) }}</b><br>
					</td>
					<td colspan="3" class="leftmargin">
						<center><b>{{ ucwords($params->Order_Type) }}</b> <br>
						<span style="font-size:18px">Rs. {{ ucwords($params->Cod_Amount) }}/-</span></center>
					</td>
				</tr>
				<tr>
					<td colspan="3">
