        ...
        <div class="mb-3 me-auto">
            <div class="card-tabs style-1 mt-3 mt-sm-0">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="intransit">In Transit  ({{$in_transit}})</a>
                    </li>
                    <li class="nav-item">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12 order-lg-1">
                                                    ...
                                                    <form id="filterForm" action="{{ url('/intransit') }}" method="get">
                                                        ...
                                                        <a href="{{ url('/intransit') }}" class="btn btn-secondary ms-sm-auto mb-2 mb-sm-0">Clear</a>
                                                    </form>
