            ...
            <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-primary mr-2">Download Shipping Label</button>
                            </div>
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-primary mr-2">Cancel Orders</button>
                            </div>
                        </div>
                    </div>
...
function checkFileContent(){
    ...
    reader.onload = function (e) {
      ...
      var Pincodetype;
        ...
        var cnt=0;
        var crtno=2;
        var checkString='Order_ID*,Customer_Name*,Address*,Customer_City*,Customer_State*,Pincode*,Mobile*,Product_Name*,Quantity*,Order_Type*,COD_AMOUNT*,Weight(Kg)*,Length(Cm)*,Breadth(Cm)*,Height(Cm)*,Invoice_Value*,Total_Amount*,Hub_Code*';
        ...
        if (text.indexOf(checkString) == 0 ) {
            if(totallen > 5000){
                ...
                for(var i=0; i< totallen; i++ ){
                    ...
                    if(Order_Type !='COD' && Order_Type !='PP'){              
                        message='Line no '+crtno+', Order Type must be either COD or PP ....!';
                        break;  
                    }
