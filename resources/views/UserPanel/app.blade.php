		...
		<ul class="metismenu" id="menu">
			<li class="dropdown header-profile">
				...
				<!-- <div class="dropdown-menu dropdown-menu-end"> -->
					<!-- <a href="{{ asset('/setting') }}" class="dropdown-item ai-icon">
					...
					<!-- <a href="{{ asset('/Logout') }}" class="dropdown-item ai-icon">
			...
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="{{asset('/UPMIS_Report')}}">MIS<span class="badge badge-xs badge-success ms-3">Update</span></a></li>
					<!--<li><a href="{{asset('/page-error-503')}}">Menifest<span class="badge badge-xs badge-success ms-3">Update</span></a></li>-->
					<li><a href="{{asset('/page-error-503')}}">NDR<span class="badge badge-xs badge-success ms-3">Update</span></a></li>
