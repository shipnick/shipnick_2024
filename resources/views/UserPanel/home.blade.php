                            ...
                            <div class="card-body p-4">
                                <div class="media ai-icon d-flex">
                                    ...
                                    <div class="media-body">
                                        <h3 class="invoice-num f-24"><span class="counter ms-0 f-24">{{$MonthlyOrder}}</span></h3>
