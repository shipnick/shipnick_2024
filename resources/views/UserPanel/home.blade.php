    ...
    ***********************************-->
    ...
    <div class="col-xl-9 col-xxl-12">
								...
								<div class="row align-items-center">
								    <div class="col-xl-6">
										<div class="card-bx bg-blue">
											<img class="pattern-img" src="images/pikaso_texttoimage_35mm-film-photography-A-professional-and-modern-lo.jpeg" alt="" style="opacity: 0.5;">
											<div class="card-info text-white">
												<img src="images/pattern/circle.png" class="mb-4" alt="">
												<h3 class="text-white card-balance">Welcome to Shipnick !</h3>
												<p class="fs-16">Choose Your Preferred Courier Partner </p><br>
												<span> </span><br>
												<br>
											</div>
									...
									<div class="col-xl-6">
										<div class="card-bx bg-blue">
											<img class="pattern-img" src="images/2446995.jpg" alt="" style="opacity: 0.5;">
											<div class="card-info text-white">
												<img src="images/pattern/circle.png" class="mb-4" alt="">
												<h2 class="text-white card-balance"><i style="font-size:24px" class="fa">&#xf095;</i>     011-69656828 (Ext. 2)</h2>
												<p class="fs-16">&nbsp; </p><br>
												<span class="fs-20"><b> For any Kind of Support Contact Us</b></span>
											</div>
				...
				<div class="row invoice-card-row">
							...
							<div class="card-body p-4">
								<div class="media ai-icon d-flex">	
									...
									<div class="media-body">
										<h3 class="invoice-num">{{$MonthlyOrder}}</h3>
					...
					<div class="col-xl-3 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
						<div class="widget-stat card invoice-card">
							<div class="card-body p-4">
								<div class="media ai-icon d-flex">	
									<span class="me-3 bgl-primary text-primary">
										<!-- <i class="ti-user"></i> -->
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ms-0">₹{{$codamount}}</span></h3>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon d-flex">	
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ms-0">{{$callpending}}</span></h3>
										<p class="mb-0">Delayed Pickup</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon d-flex">	
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ms-0">{{$monthndr}}</span></h3>
										<p class="mb-0">NDR ACTION REQUIRED</p>
									</div>
								</div>
							</div>
						</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <script>
                    ...
                    var data = {
                        labels: [' ', ' ', ' '],
                        series: [{{ $percentage_xpressbeeFormatted ?? 0 }},
                {{ $percentage_ecomFormatted ?? 0 }},
                {{ $percentage_bluedartFormatted ?? 0 }}] // Sample data values
                    };
