...
<div class="right-wrapper pull-right">
	...
	<li><a href="#" class="btn btn-success" data-toggle="modal" data-target="#myModal" style="color:white;margin-right:10px">Add New Client</a></li>
	</ol>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <!--  -->
        ...
        <h4 class="modal-title text-center" style="color:black"><b>Add New Client</b></h4>
      <!--  -->
      </div>
      ...
      <form method="POST" action="{{ asset('/New_Client') }}">
        ...
        <div class="col-md-12">
        	...
        	<div class="col-md-6">
        		<input type="email" name="email" class="form-control" placeholder="Eamil" required="">
        	</div>
        </div>
        ...
        <div class="col-md-12 text-center"><br>
        	<div class="col-md-12">
        		@csrf
                <button class="btn btn-success">&ensp;&ensp; Add a Client &ensp;&ensp;</button>
        	</div>
            <br><br>
        </div>
