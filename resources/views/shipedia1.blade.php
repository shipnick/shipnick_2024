...
<body>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="https://shipnick.com/" class="logo d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="get-a-quote" href="https://shipnick.com/login">Login</a></li>
        </ul>
      </nav><!-- .navbar -->
    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        ...
        <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
          <img src="home/assets/img/hero-img.svg" class="img-fluid mb-3 mb-lg-0" alt="">
        </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up">
            ...
            <div>
              <h4 class="title">Leader in industry</h4>
              <p class="description">We are aggregator in logistic industry.</p>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
            ...
            <div>
              <h4 class="title">Multiple Shipping Options</h4>
              <p class="description">We have multiple channel partners</p>
              <a href="service-details.html" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
            ...
            <div>
              ...
              <p class="description">QWe are waiting for you. You can access our applications with hassle free and simple processuick and hassle free shipments</p>
              <a href="service-details.html" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            <h3>Reach us</h3>
            <p>We are waiting for you. You can access our applications with hassle free and simple process.</p>
            <a class="cta-btn" href="https://shipnick.com/contact">Contact Us</a>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          ...
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <img src="home/assets/img/hw1.gif" class="img-fluid" alt="">
			<p style="margin-top: 60px;">Push your orders via api / excel file upload</p>
          </div>
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
			<img src="home/assets/img/load6.gif" class="img-fluid" alt="">
			<p style="margin-top: 55px;">Print shipping labels & dispatch</p>
          </div>
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <img src="home/assets/img/load5.gif" class="img-fluid" alt="">
			<p style="margin-top: 60px;">Track your shipment updates in real time</p>
          </div>
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <img src="home/assets/img/load7.gif" class="img-fluid" alt="">
			<p>Monitor your performance & growth from dashboard</p>
          </div>
        </div>
		</div></div>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info">
          ...
          <p>Create shipping labels faster with the most advanced logistics software for e-commerce.</p>
        ...
        <div class="col-lg-2 col-6 footer-links">
          ...
          <ul>
            ...
            <li><a href="#">Freight Services</a></li>
            <li><a href="#">E commerce courier</a></li>
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          ...
          <p>
            ...
            <strong>Email:</strong> info@shipnick.com<br>
          </p>
