...
<?php $xbstatus = "notchecked"; ?>
    @foreach($permissions as $permission)
        @if($permission->courier_code==$param->courier_code && $permission->courier_by==$param->courier_by && $permission->admin_flg=='1' && $permission->user_id==$id)
    ...
    <tr>
        ...
        <td><?php echo $param->display_courier_by; ?></td>     
        <td>
            <label class="switch">
...
function change_status(code,courier,courieridno,obj){
    ...
    data:{code:code,courier:courier,userid:userid,courieridno:courieridno,value:value},
