            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('user-weight-add')}}/{{ $params->id }}" method="post">@csrf
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">AWB</label>
                                <div class="col-sm-4">
                                    <input type="text" name="awb" class="form-control" id="inputEmail3" placeholder="Enter awb">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select id="inputState" class="form-control" name="Type">
                                        ...
                                        <option value="cheque">Extra weight</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="weight" class="form-control" id="inputEmail3" placeholder="Enter weight">
                                </div>
                            </div>
