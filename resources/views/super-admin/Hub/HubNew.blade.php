...
<form method="post" action="{{ asset('/New_Hub') }}">
	<div class="row"><br>
		<div class="col-md-6">
			<input type="text" name="name" class="form-control" placeholder="Hub Name *" required="">
		</div>
		<div class="col-md-6">
	...
	<div class="row"><br>
		<div class="col-md-6">
			<input type="text" name="mobile" class="form-control" placeholder="Mobile No *" pattern="[0-9]+" minlength="10" maxlength="12" required="">
		</div>
		<div class="col-md-6">
	...
	<div class="row"><br>
		...
		<div class="col-md-6">
			<input type="text" name="pincode" class="form-control" placeholder="Pincode *" pattern="[0-9]+" required="">
		</div>
	</div>

	<div class="row"><br>
		<div class="col-md-6">
			<textarea class="form-control" name="address1" rows="5" placeholder="Address 1 *" required=""></textarea>
		</div>
		<div class="col-md-6">
			<textarea class="form-control" name="address2" rows="5" placeholder="Address 2"></textarea>
		</div>
	</div>
