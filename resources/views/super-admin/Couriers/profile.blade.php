...
<ul>
<li class="nav-item">
<a href="{{ asset('/setting') }}" class="nav-link active">
<i class="far fa-user"></i> <span>Profile Settings</span>
</a>
</li>
<li class="nav-item">
<a href="{{ asset('/financial-details') }}" class="nav-link">
<i class="far fa-list-alt"></i> <span>Financial Details</span>
</a>
</li>
<li class="nav-item">
<a href="{{ asset('/billing-information') }}" class="nav-link">
...
@else
    <img id="avatarImg" class="avatar-img" src="assets/img/profiles/avatar-01.png" alt="{{ $params->name }}">
@endif
...
<div class="col-sm-9">
<input type="email" class="form-control" name="email" placeholder="Email" value="{{ $params->username }}">
</div>
</div>
<div class="row form-group">
