...
<div class="main-panel">
    <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                <p class="mb-4">Total No Admins</p>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                        <div class="card card-light-blue">
                            <div class="card-body">
                                <p class="mb-4">Cod Orders</p>
                                <p class="fs-30 mb-2">soon</p>
                                <p>00.00% (0 days)</p>
                            </div>
                        </div>
                    </div>
        ...
        <!--                                                        <td class="w-100 px-0">-->
        <!--                                                            <div class="progress progress-md mx-4">-->
        <!--                                                                <div class="progress-bar bg-danger" role="progressbar" style="width: 75%" aria-valuenow="79" aria-valuemin="0" aria-valuemax="100"></div>-->
        <!--                                                            </div>-->
        <!--                                                        </td>-->
        <!--                                                        <td>-->
        <!--                                                            <h5 class="font-weight-bold mb-0">793</h5>-->
