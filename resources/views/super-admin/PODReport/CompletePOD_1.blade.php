...
<div class="right-wrapper pull-right">
	...
	<li><a href="{{ asset('/AComplete_POD_Report_Export') }}" class="btn btn-success" style="color:white;margin-right:10px">Download Excel</a></li>
	</ol>
