...
var Swiper = function() {
    ...
    function B(e) {
        ...
        if (i.isScrolling && s.emit("touchMoveOpposite", p), void 0 === i.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (i.startMoving = !0)), i.isScrolling || s.zoom && s.params.zoom && s.params.zoom.enabled) return void(i.isTouched = !1);
    ...
    const Q = {
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = Y.bind(e), e.onTouchMove = B.bind(e), e.onTouchEnd = R.bind(e), e.onDocumentTouchStart = j.bind(e), t.cssMode && (e.onScroll = F.bind(e)), e.onClick = q.bind(e), e.onLoad = _.bind(e), W(e, "on")
                },
