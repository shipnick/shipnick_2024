    ...
    return {
        init: function () {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(),
                ...
                jQuery(".dlab-chat-user-box .dlab-chat-user").on(
                    "click",
                    function () {
                        jQuery(".dlab-chat-user-box").addClass("d-none"),
                            jQuery(".dlab-chat-history-box").removeClass(
                                "d-none"
                            );
                    }
                ),
                ...
                jQuery("#lightgallery").length > 0 &&
                    $(
                        "#lightgallery ,#lightgallery-1 ,#lightgallery-2 "
                    ).lightGallery({
                        loop: !0,
                        thumbnail: !0,
