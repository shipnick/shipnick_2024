...
{
    private const QUEUE_NAME = 'o_status_rapidship';
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'spnk:rapidship_job';
     ...
     * @var string
     */
    protected $description = 'Creates Rapidship order status update jobs';
    ...
    public function handle()
    {
        ...
        $orders = bulkorders::where('awb_gen_by', 'EkartRS')
        ...
        foreach ($orders as $order) {
            OrderStatusUpdate_RapidShipJob::dispatch($order->toArray())->onQueue(self::QUEUE_NAME);
        }
