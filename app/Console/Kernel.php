...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('spnk:ecom_job')->name('status_update_ECOM')->description('Schedules status update job for orders in ECOM api')->everyFourHours();
        $schedule->command('spnk:xpressbee_job')->name('status_update_XPREBEE')->description('Schedules status update job for orders in Xpressbee api')->everyFourHours();
