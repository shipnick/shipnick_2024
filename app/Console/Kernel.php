...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        })->name('status_update_ECOM')->description('Schedules status update job for orders in ECOM api')->everyTwoHours();
        ...
        })->name('status_update_XPREBEE')->description('Schedules status update job for orders in Xpressbee api')->everyTwoHours();
        ...
        $schedule->command('queue:work --queue=order_status --timeout=240 --tries=3 --once')->name('order_status_worker')->description("Process job from order_status queue")
        ->everyMinute()
        // ->withoutOverlapping()
