        ...
        foreach ($params as $param) {
            ...
            foreach ($finalcourierlists as $courierapicodeno) {
                ...
                $testrequestcode = '{
                    ...
                    "orders":[
                 {
                 "client_order_reference_id":"147269",
                 "shipment_type":1,
                 ...
                 "shipper_hub_id":"97851",
                 "shipper_gst_no":"",
                 "order_invoice_date":"20-10-2023",
                ...
                "product_details":[
                {
                  "client_product_reference_id":"127779867",
                  "product_name":"' . $iname . '",
                  "product_category":"",
                ...
                echo "<pre>";
                print_r($testrequestcode);
                echo "</pre><br>--------------------------------<br><br>";


                echo $courierapicodeno;
                // if ($courierapicodeno == "SMP") {
                // $courierapicodeno = "SMP";
                if ($courierapicodeno == "smp01") {
                    ...
                    // $data=DB::select("select token from smartships");
                    $smartshiptoken = $smartshiptoken1['token'];


                    // Warehouse Pickup ID
                     $hubintartosid = Hubs::where('hub_id', $pkpkid)->first('smartship_hubid');
                      $warehouseid = $hubintartosid['smartship_hubid'];
                    ...
                    curl_setopt_array($curl, array(
                        ...
                        CURLOPT_POSTFIELDS => '{
                            ...
                            "product_details":[
                            {
                            "client_product_reference_id":"' . $orderno . '",
                            "product_name":"' . $iname . '",
                   ...
                   ',
                    ...
                    if ($statuscheck == 1) {
                        ...
                        bulkorders::where('Single_Order_Id', $crtidis)->update(['courier_ship_no' => $smartshiporderid, 'Awb_Number' => $awbnosmartship, 'awb_gen_by' => $carrierby, 'awb_gen_courier' => 'Smartship']);
                    } elseif ($statuscheck == false) {
                       echo $errmessage =  $responseco['data']['errors']['data_discrepancy']['0']['error']['0']; 
...
public function OrderPlaceToCourier()
    {
        ...
        foreach ($params as $param) {
            ...
            foreach ($finalcourierlists as $courierapicodeno) {
                ...
                echo "Line no finalcourierlists";
                ...
                if ($courierapicodeno == "smp01") {
                    ...
                    $smartshiptoken1 = smartship::where('id', 1)->first('token');
                    // $data=DB::select("select token from smartships");
                    echo $smartshiptoken = $smartshiptoken1['token'];


                    // Warehouse Pickup ID
                    $hubintartosid = Hubs::where('hub_id', $pkpkid)->first('smartship_hubid');
                    echo  $warehouseid = $hubintartosid['smartship_hubid'];
            ...
            //   if($checkerror1 = "true")
            //   {
            //       echo "mandatory field value missing";
            //   }
              
echo    @ $checkerror = $responseco['data']['errors']['data_discrepancy']['0']['error']['0']; 

//  echo     $checkerror1 = $responseco['data']['errors']['mandatory_field_value_missing']['field']; 
echo $hellow= $responseco['data']['success_order_details']['orders']['0']['carrier_name'];
...
if ($checkerror == "")
{
    ...
    bulkorders::where('Single_Order_Id', $crtidis)->update(['showerrors' => $checkerror]);
}
                    ...
                    echo " <br>0:-";
                    echo     $intargosawbnois1 = $responseco['data']['success_order_details']['orders']['0']['sc_confirmation_no'];
                    echo " <br>2:-";
                    echo " <br>1:-";
                    echo     @$intargosawbnois = $responseco['data']['success_order_details']['orders']['0']['awb_number'];
                    echo " <br>2:-";
                    echo     @$thisgenerateawbno = $intargosawbnois;
                    echo " <br>3:-"; 
                    echo     @$carrierby = $responseco['data']['success_order_details']['orders']['0']['carrier_name'];
                    echo " <br>4:-";
                    echo     @$intarorderid = $responseco['data']['success_order_details']['orders']['0']['request_order_id'];
                    // InTargos Order Place End //
                    // dd($intarorderid); 
                    echo $statuscheck = $responseco['status'];
        ...
        },
        {
            ...
            "product_taxper": 0
                    ...
                    if ($responseio['status'] == "true") {
                        ...
                        $carrierby = $responseio['carrier'];
                        $intarorderid = $responseio['intargos_orderid'];
                        bulkorders::where('Single_Order_Id', $crtidis)->update(['courier_ship_no' => $intarorderid, 'Awb_Number' => $intargosawbnois, 'awb_gen_by' => $carrierby, 'awb_gen_courier' => 'Intargos1']);
                    } else {
                        $errormsg = $responseio['response'];
                        bulkorders::where('Single_Order_Id', $crtidis)->update(['showerrors' => $errormsg]);
                    }
        ...
        if ($courierapicodeno == "smp01") {
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_POSTFIELDS => '{
                    ...
                    "product_details":[
                    {
                    "client_product_reference_id":"' . $autogenorderno . '",
                    "product_name":"' . $iname . '",
                    "product_category":"none",
                    "product_hsn_code":"' . $orderno . '",
                    "product_quantity":"' . $iqlty . '",
           ...
           ',
            ...
            // if($responseco['status'] == "true"){
            
                // $intargosawbnois1 = $responseco['data']['success_order_details']['orders']['0']['sc_confirmation_no'];
            
          //   @$intargosawbnois = $responseco['data']['success_order_details']['orders']['0']['awb_number'];
           
          //     @$thisgenerateawbno = $intargosawbnois;
        
          //          @$carrierby = $responseco['data']['success_order_details']['orders']['0']['carrier_name'];
         
           //     @$intarorderid = $responseco['data']['success_order_details']['orders']['0']['request_order_id'];
            // InTargos Order Place End //
            // dd($intarorderid);
            $statuscheck=$responseco['status'];
