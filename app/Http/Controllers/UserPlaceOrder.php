...
class UserPlaceOrder extends Controller
{
    public function search_order(Request $req)
    {
        ...
        // Helper function to calculate the counts
        ...
        $pending_pickup = $getOrderCount(['Pickup Scheduled', 'Shipment Not Handed over', 'pending pickup', 'AWB Assigned', 'Pickup Error', 'Pickup Rescheduled', 'Out For Pickup', 'Pickup Exception', 'Pickup Booked', 'Shipment Booked', 'Pickup Generated','Booked'], $currentMonthStart, $currentMonthEnd);
