...
// UserPanel Zone Wise Performance
   ...
   public function showOrderCounts()
  {
      ...
      return view('UserPanel.DashboardData.analytics', compact(
          'xpressbee', 'xpressbeePending', 'xpressbeeIntransit', 'xpressbeeOfd', 'xpressbeeNDR', 'xpressbeeDelivered', 'xpressbeeRto',
          'xpressbeePrepaid', 'xpressbeePrepaidPending', 'xpressbeePrepaidIntransit', 'xpressbeePrepaidOfd', 'xpressbeePrepaidNDR', 'xpressbeePrepaidDelivered', 'xpressbeePrepaidRto',
          'xpressbeeCod', 'xpressbeeCodPending', 'xpressbeeCodIntransit', 'xpressbeeCodOfd', 'xpressbeeCodNDR', 'xpressbeeCodDelivered', 'xpressbeeCodRto',
          'Ecom', 'EcomPending', 'EcomIntransit', 'EcomOfd', 'EcomNdr', 'EcomDeliverd', 'EcomRto',
          'EcomPrepaid', 'EcomPrepaidPending', 'EcomPrepaidIntransit', 'EcomPrepaidOfd', 'EcomPrepaidNdr', 'EcomPrepaidDelivered', 'EcomPrepaidRto',
          'EcomCod', 'EcomCodPending', 'EcomCodIntransit', 'EcomCodOfd', 'EcomCodNdr', 'EcomCodDelivered', 'EcomCodRto',

        'Bluedart', 'BluedartPending', 'BluedartIntransit', 'BluedartOfd', 'BluedartNdr', 'BluedartDeliverd', 'BluedartRto',
          'BluedartPrepaid', 'BluedartPrepaidPending', 'BluedartPrepaidIntransit', 'BluedartPrepaidOfd', 'BluedartPrepaidNdr', 'BluedartPrepaidDelivered', 'BluedartPrepaidRto',
          'BluedartCod', 'BluedartCodPending', 'BluedartCodIntransit', 'BluedartCodOfd', 'BluedartCodNdr', 'BluedartCodDelivered', 'BluedartCodRto'
      ));
  }
